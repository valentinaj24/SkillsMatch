...
// ─── Star Painter (decorative sparkles like login screen) ────────────────────
...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  late AnimationController _pulseCtrl; // NEW: pulsing ring like login
  late AnimationController _floatCtrl; // NEW: floating image like login
  late Animation<double> _fadeAnim;
  late Animation<Offset> _slideAnim;
  late Animation<double> _btnScale;
  late Animation<double> _pulseAnim; // NEW
  late Animation<double> _floatAnim; // NEW
  ...
  void initState() {
    ...
    // Pulsing ring animation (matches login style)
    ...
    // Floating/bobbing animation (matches login style)
  ...
  // ── Header (UPDATED - now with animated image like login) ─────────────────
    ...
    builder: (_, __) => Container(
      ...
      child: Stack(
        children: [
          ...
          // Animated sparkle stars (matching login)
          Positioned.fill(
            child: CustomPaint(
          ...
          Column(
            ...
            children: [
              // ── Animated image with pulsing rings (matches login) ──────────────
              Transform.translate(
      ...
      children: [
        ...
        Center(
          child: Text(
            ...
            style: TextStyle(fontSize: 11, color: _kTextSub.withOpacity(0.55)),
          ),
        ),
        const SizedBox(height: 10),
      ],
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // Form card — overlaps header like login
                Padding(
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            // Card header — centered like login
                            Center(
                              child: Column(
                                children: [
                                  Container(
