...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  void initState() {
    super.initState();
    _entryCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 950));
    ...
    for (int i = 0; i < 8; i++) {
      ...
      _fSlide.add(Tween<Offset>(begin: const Offset(0.05, 0), end: Offset.zero).animate(
          CurvedAnimation(parent: _entryCtrl, curve: Interval(s, e, curve: Curves.easeOut))));
    }

    _orbCtrl = AnimationController(vsync: this, duration: const Duration(seconds: 9))..repeat();
    _btnCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 110));
    ...
    _entryCtrl.forward();
    passwordController.addListener(() => setState(() => _pwStrength = _evalPw(passwordController.text)));
    for (final c in [imeController, priimekController, emailController, telefonController, lokacijaController, confirmPasswordController]) {
      c.addListener(() => setState(() {}));
    }
    for (final fn in [_imeFN, _priimekFN, _emailFN, _telefonFN, _lokacijaFN, _passwordFN, _confirmFN]) {
  ...
  void dispose() {
    ...
    _pulseCtrl.dispose();
    _floatCtrl.dispose();
    for (final c in [imeController, priimekController, emailController, telefonController, lokacijaController, passwordController, confirmPasswordController]) {
      c.dispose();
    }
    for (final f in [_imeFN, _priimekFN, _emailFN, _telefonFN, _lokacijaFN, _passwordFN, _confirmFN]) {
      f.dispose();
    }
    super.dispose();
  }
              ...
              TweenAnimationBuilder<double>(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: _kPrimary.withOpacity(0.4), blurRadius: 24, offset: const Offset(0, 8))],
                  ),
                  child: const Icon(Icons.check_rounded, color: Colors.white, size: 46),
                ),
              ),
              const SizedBox(height: 20),
              Text('Dobrodošli! 🎉', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: context.kText)),
              ...
              SizedBox(
                ...
                child: DecoratedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Nadaljuj na prijavo', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
                  ),
                ),
              ),
            ],
  ...
  // ── Theme‑aware helpers ─────────────────────────────────────────────────
  InputDecoration _deco(String hint, IconData icon, FocusNode fn, {Widget? suffix}) {
    final focused = fn.hasFocus;
    return InputDecoration(
      hintText: hint,
      hintStyle: TextStyle(color: context.isDark ? const Color(0xFF9CA3AF) : const Color(0xFFCBD5E1), fontSize: 14),
      prefixIcon: Icon(icon, color: focused ? _kPrimary : const Color(0xFFA5B4FC), size: 20),
      suffixIcon: suffix,
      filled: true,
      fillColor: focused ? (context.isDark ? const Color(0xFF2A2A3E) : const Color(0xFFF0F0FF)) : context.kSurface,
  ...
  Widget _lbl(String t) => Padding(
    ...
    child: Text(t, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: context.kText)),
  );
  ...
  Widget _header() => AnimatedBuilder(
    ...
    builder: (_, __) => Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(colors: _headerGradientColors, begin: Alignment.topLeft, end: Alignment.bottomRight),
      ),
      child: Stack(
        children: [
          ...
          Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Colors.white.withOpacity(0.55), width: 3.0),
                        boxShadow: [
                          BoxShadow(color: Colors.black.withOpacity(0.35), blurRadius: 36, offset: const Offset(0, 12)),
                          BoxShadow(color: _kViolet.withOpacity(0.50), blurRadius: 30, spreadRadius: 2, offset: const Offset(0, 4)),
                          BoxShadow(color: _kPrimary.withOpacity(0.30), blurRadius: 50, spreadRadius: 6),
                        ],
                      ),
                      child: ClipOval(
                        child: Image.asset('assets/images/slika3.png', fit: BoxFit.cover,
                          errorBuilder: (_, __, ___) => const Icon(Icons.person_add_alt_1_rounded, color: Colors.white, size: 52)),
                      ),
                    ),
                  ],
                ),
              ...
              const Text('Registracija', style: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.bold, letterSpacing: -0.5)),
              ...
              Container(
                ...
                child: const Row(mainAxisSize: MainAxisSize.min,
                  children: [Icon(Icons.verified_rounded, color: Colors.white70, size: 14), SizedBox(width: 5),
                    Text('Skills Match Skupnost', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w500))]),
              ),
              const SizedBox(height: 12),
              const Text('Ustvarite račun in odkrijte skupnost\nzaupanja vrednih strokovnjakov.',
                textAlign: TextAlign.center, style: TextStyle(color: Colors.white70, fontSize: 14, height: 1.6)),
        ...
        for (int i = 0; i < labels.length; i++) ...[
          Column(
            children: [
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: done[i] ? Colors.white : i == _currentStep ? Colors.white.withOpacity(0.9) : Colors.white.withOpacity(0.15),
                  border: Border.all(color: Colors.white.withOpacity(done[i] ? 1.0 : i == _currentStep ? 0.8 : 0.35), width: 1.5),
                  boxShadow: done[i] || i == _currentStep ? [BoxShadow(color: Colors.white.withOpacity(0.25), blurRadius: 8, offset: const Offset(0, 2))] : [],
                ),
                child: Center(
                  child: done[i]
                      ? Icon(Icons.check_rounded, size: 16, color: _kPrimary)
                      : Text('${i + 1}', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold,
              ...
              AnimatedDefaultTextStyle(
                ...
                style: TextStyle(
                  fontSize: 11,
                  fontWeight: done[i] || i == _currentStep ? FontWeight.w600 : FontWeight.normal,
                  color: done[i] ? Colors.white : i == _currentStep ? Colors.white.withOpacity(0.95) : Colors.white.withOpacity(0.45),
                ),
                child: Text(labels[i]),
              ),
            ],
          ...
          if (i < labels.length - 1)
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: done[i] ? Colors.white.withOpacity(0.8) : Colors.white.withOpacity(0.22),
              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: sel ? color : context.kBorder, width: sel ? 2 : 1.2),
                    boxShadow: sel ? [BoxShadow(color: color.withOpacity(0.2), blurRadius: 12, offset: const Offset(0, 4))] : [],
                  ),
                  child: Column(
                    children: [
                      AnimatedContainer(
                        ...
                        width: 42,
                        height: 42,
                        decoration: BoxDecoration(color: sel ? color.withOpacity(0.14) : Colors.transparent, shape: BoxShape.circle),
                        child: Icon(icon, color: sel ? color : const Color(0xFFA5B4FC), size: 22),
                      ),
                      const SizedBox(height: 6),
                      Text(name, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: sel ? color : context.kText)),
                      const SizedBox(height: 2),
                      Text(sub, textAlign: TextAlign.center,
                        // 🔧 FIX: removed const, use context.kTextSub
                        style: TextStyle(fontSize: 10, color: context.kTextSub, height: 1.3),
                      ...
                      AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: sel ? color : context.kBorder, width: 1.5),
                        ),
          ...
          children: [
            Row(children: List.generate(4, (i) => Expanded(
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(color: i < steps ? color : context.kBorder, borderRadius: BorderRadius.circular(4)),
              ),
            ))),
            const SizedBox(height: 5),
            Text('Moč gesla: ${_pwLabel(_pwStrength)}', style: TextStyle(fontSize: 11, color: color, fontWeight: FontWeight.w600)),
          ],
        ),
      ),
    );
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: _kPrimary.withOpacity(0.3), blurRadius: 22, offset: const Offset(0, 8))],
          ),
          child: Column(
            children: [
              Text('Skupnost v številkah',
                style: TextStyle(color: context.isDark ? Colors.white : context.kText, fontSize: 16, fontWeight: FontWeight.bold)),
              const SizedBox(height: 4),
              Text('Tisoče strokovnjakov vas že čaka',
                style: TextStyle(color: context.isDark ? Colors.white54 : context.kTextSub, fontSize: 12)),
              const SizedBox(height: 20),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  _stat('200+', 'Uporabnikov'),
                  Container(height: 34, width: 1, color: context.isDark ? Colors.white24 : Colors.black12),
                  _stat('100+', 'Mentorjev'),
                  Container(height: 34, width: 1, color: context.isDark ? Colors.white24 : Colors.black12),
        ...
        Row(
          children: [
            _feat(Icons.security_rounded, 'Varnost', 'SSL šifriranje in zaščita podatkov',
                const Color(0xFF059669), context.isDark ? const Color(0xFF0C1F18) : const Color(0xFFECFDF5)),
            const SizedBox(width: 10),
            _feat(Icons.verified_rounded, 'Preverjeno', 'Verificirani profili v skupnosti',
                const Color(0xFF7C3AED), context.isDark ? const Color(0xFF1A1933) : const Color(0xFFF5F3FF)),
            const SizedBox(width: 10),
            _feat(Icons.bolt_rounded, 'Hitro', 'Takojšnja aktivacija računa',
                const Color(0xFFD97706), context.isDark ? const Color(0xFF1F1A0F) : const Color(0xFFFFFBEB)),
          ],
        ),
        const SizedBox(height: 12),
        // How it works
        Container(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(children: [Icon(Icons.info_outline_rounded, color: _kPrimary, size: 18),
                const SizedBox(width: 8),
                Text('Kako deluje?', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: context.kText))]),
        ...
        const SizedBox(height: 22),
        Center(
          child: Text('© 2026 Skills Match · Vse pravice pridržane',
            style: TextStyle(fontSize: 11, color: context.kTextSub.withOpacity(0.55))),
        ),
        const SizedBox(height: 10),
      ],
    ),
  ...
  Widget _stat(String v, String l) => Column(
    children: [
      Text(v, style: TextStyle(color: context.isDark ? Colors.white : context.kText, fontSize: 22, fontWeight: FontWeight.bold)),
      const SizedBox(height: 2),
      Text(l, style: TextStyle(color: context.isDark ? Colors.white54 : context.kTextSub, fontSize: 11)),
    ],
  );

  Widget _feat(IconData icon, String title, String sub, Color c, Color bg) => Expanded(
    child: Container(
      padding: const EdgeInsets.all(14),
      decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(18), border: Border.all(color: c.withOpacity(0.2))),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(icon, color: c, size: 24),
          const SizedBox(height: 8),
          Text(title, style: TextStyle(color: c, fontSize: 12, fontWeight: FontWeight.bold)),
          const SizedBox(height: 2),
          Text(sub, style: TextStyle(fontSize: 10, color: context.kTextSub, height: 1.4)),
        ],
      ),
    ),
  );
    ...
    child: Row(
      ...
      children: [
        Container(
          width: 28,
          height: 28,
          decoration: const BoxDecoration(gradient: LinearGradient(colors: [_kPrimary, _kViolet]), shape: BoxShape.circle),
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13, color: context.kText)),
              Text(sub, style: TextStyle(fontSize: 12, color: context.kTextSub)),
            ],
          ),
        ),
      ],
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(label, style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: context.kText)),
        ],
      ),
    ),
  );
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [BoxShadow(color: _kPrimary.withOpacity(0.35), blurRadius: 18, offset: const Offset(0, 6))],
                                    ),
                                    child: const Icon(Icons.edit_note_rounded, color: Colors.white, size: 36),
                                  ),
                                  const SizedBox(height: 14),
                                  Text('Ustvari račun', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: context.kText)),
                                  const SizedBox(height: 4),
                                  Text('Vnesite svoje podatke za nov račun.',
                                      style: TextStyle(fontSize: 13, color: context.kTextSub)),
                                ],
                              ),
                            ),
                            const SizedBox(height: 24),
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: OutlinedButton.icon(
                                    ...
                                    label: Text(isGettingLocation ? 'Pridobivanje lokacije...' : 'Uporabi trenutno lokacijo'),
                              ...
                              GestureDetector(
                                ...
                                child: ScaleTransition(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: DecoratedBox(
                                      decoration: BoxDecoration(
                                        gradient: isLoading ? null : const LinearGradient(colors: [_kPrimary, _kViolet]),
                                        color: isLoading ? (context.isDark ? const Color(0xFF2A2A3E) : const Color(0xFFE2E8F0)) : null,
                                      ...
                                      child: ElevatedButton.icon(
                                        ...
                                        label: Text(isLoading ? 'Ustvarjanje...' : 'Ustvari račun',
                              ...
                              child: TextButton(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: const [TextSpan(text: 'Prijava →',
