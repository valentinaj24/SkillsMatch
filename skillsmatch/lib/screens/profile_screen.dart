...
class _EmptySkills extends StatefulWidget {
  const _EmptySkills();
  @override State<_EmptySkills> createState() => _EmptySkillsState();
}
        ...
        TweenAnimationBuilder<double>(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: _kPrimary.withOpacity(0.28),
                  blurRadius: 14, offset: const Offset(0, 4))]),
            child: const Icon(Icons.lightbulb_rounded,
                color: Colors.white, size: 28))),
        const SizedBox(height: 12),
        const Text('Dodajte vsaj eno veščino', style: TextStyle(
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  void dodajVescino() {
    ...
    setState(() {
      vescine.add(Skill(naziv: vescinaController.text.trim(),
          nivoZnanja: nivoZnanja, tip: tipVescine));
  ...
  Future<void> potrdiBrisanje(Skill skill) async {
    final result = await showDialog<bool>(
      ...
      builder: (ctx) => Dialog(
        ...
        child: Container(
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(24), color: _kCardBg),
  ...
  void _prikaziUspeh() => showDialog(context: context, builder: (ctx) => Dialog(
        ...
        child: Row(children: [
          Container(width: 42, height: 42,
            decoration: BoxDecoration(
              ...
              shape: BoxShape.circle),
            child: Icon(
              canTeach ? Icons.volunteer_activism_rounded
          ...
          Expanded(child: Column(
            ...
            Row(children: [
              ...
              Flexible(child: Text(skill.tip, overflow: TextOverflow.ellipsis,
    ...
    return Expanded(child: GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(children: [
          ...
          Text(tip, textAlign: TextAlign.center, style: TextStyle(
              fontSize: 11,
                      ...
                      child: Column(
                        ...
                        Row(children: [
                          Expanded(child: Column(
                              ...
                              children: [
                            _lbl('Ime *'),
                            TextFormField(controller: imeController,
                              focusNode: _imeFN,
                          ...
                          Expanded(child: Column(
                              ...
                              children: [
                            _lbl('Priimek *'),
                            TextFormField(controller: priimekController,
                        ...
                        _lbl('Kratek opis'),
                        TextFormField(controller: opisController,
                          focusNode: _opisFN, maxLines: 3,
                          decoration: _deco('Opišite se v nekaj besedah...',
                              Icons.description_outlined, _opisFN, maxLines: 3)),
                        const SizedBox(height: 14),
                        _lbl('Lokacija *'),
                        TextFormField(controller: lokacijaController,
                ...
                _anim(1, Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      const SizedBox(height: 20),
                      _lbl('Nova veščina'),
                      TextFormField(controller: vescinaController,
                      ...
                      _lbl('Tip veščine'),
                      Row(children: [
                        _tipCard('Želim se naučiti', Icons.school_rounded,
                            const Color(0xFFD97706), const Color(0xFFFFFBEB)),
                        const SizedBox(width: 10),
                        _tipCard('Lahko učim druge',
                            Icons.volunteer_activism_rounded,
                            _kPrimary, const Color(0xFFEEF2FF)),
                      ]),
                      const SizedBox(height: 16),
                      SizedBox(width: double.infinity, height: 50,
                        child: DecoratedBox(
                    ...
                    child: SizedBox(width: double.infinity, height: 58,
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          color: isSaving ? const Color(0xFFE2E8F0) : null,
                          borderRadius: BorderRadius.circular(18),
