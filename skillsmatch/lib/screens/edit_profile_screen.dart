...
class _EditProfileScreenState extends State<EditProfileScreen>
  ...
  void initState() {
    ...
    _addPanelCtrl = AnimationController(vsync: this,
        duration: const Duration(milliseconds: 350));
    _addPanelAnim = CurvedAnimation(
        parent: _addPanelCtrl, curve: Curves.easeOutCubic);
  ...
  @override
  void dispose() {
    _orbCtrl.dispose(); _entryCtrl.dispose();
    _btnCtrl.dispose(); _addPanelCtrl.dispose();
  ...
  Future<void> naloziProfil() async {
    ...
    if (!doc.exists) { setState(() => isLoading = false); return; }
    final data = doc.data()!;
    setState(() {
  ...
  Future<String> uploadProfileImage(String uid) async {
    ...
    setState(() { photoUrl = imageUrl; isUploadingImage = false; });
    return imageUrl;
  }
  ...
  void dodajVescino() {
    ...
    if (naziv.isEmpty) {
      _snack('Vnesite naziv veščine.', Colors.redAccent); return;
    }
    setState(() {
      vescine.add({'naziv': naziv, 'nivoZnanja': nivoZnanja, 'tip': tipVescine});
  ...
  Future<void> shraniSpremembe() async {
    ...
    final uid = FirebaseAuth.instance.currentUser?.uid;
    if (uid == null) { _snack('Uporabnik ni prijavljen.', Colors.redAccent); return; }
    ...
    try {
      ...
      if (!mounted) return;
      setState(() { isSaving = false; isUploadingImage = false; });
      ...
      return GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: sel ? [BoxShadow(color: _kPrimary.withOpacity(0.25),
      ...
      return GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: sel ? [BoxShadow(color: color.withOpacity(0.28),
                blurRadius: 8, offset: const Offset(0, 3))] : []),
          child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: sel ? color : _kBorder,
                width: sel ? 2 : 1.2),
            boxShadow: sel ? [BoxShadow(color: color.withOpacity(0.18),
                blurRadius: 8, offset: const Offset(0, 3))] : []),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Icon(icon, color: sel ? color : const Color(0xFFA5B4FC), size: 20),
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: canTeach ? [_kPrimary, _kViolet]
          ...
          Expanded(child: Column(
            ...
            Text(v['naziv'] ?? '', style: const TextStyle(
            ...
            Row(children: [
              Container(
                ...
                child: Text('${v['nivoZnanja']} • ${canTeach ? "Učim" : "Učim se"}',
  ...
  Widget _photoCard() => Container(
    ...
    child: Column(children: [
      ...
      Stack(alignment: Alignment.bottomRight, children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: _kPrimary.withOpacity(0.18),
      ...
      const Text('Profilna slika', style: TextStyle(
          fontSize: 16, fontWeight: FontWeight.bold, color: _kText)),
          ...
          child: OutlinedButton.icon(
            ...
            label: Text(
              photoUrl.isEmpty && selectedImage == null
                  ? 'Dodaj sliko' : 'Spremeni sliko',
              style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
            style: OutlinedButton.styleFrom(
              foregroundColor: _kPrimary, side: BorderSide.none,
      ...
      child: Stack(children: [
        ...
        Column(children: [
          ...
          Row(children: [
            ...
            const Spacer(),
            const Text('Uredi profil', style: TextStyle(
          ...
          const Text('Posodobi svoj profil', style: TextStyle(
                    ...
                    _card(
                      ...
                      child: Column(
                        ...
                        TextFormField(
                          ...
                          focusNode: _opisFN,
                          maxLines: 3,
                          decoration: _deco('Opišite se v nekaj besedah...',
                        ...
                        if (vescine.isNotEmpty) ...[
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              ...
                              const SizedBox(height: 8),
                              const Text('Še nimate veščin',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 13, color: _kText)),
                              const SizedBox(height: 3),
                              const Text('Dodajte svojo prvo veščino spodaj.',
                                  style: TextStyle(
                        ...
                        GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(14),
                              border: _addingSkill
                                  ? Border.all(color: _kBorder) : null,
                              boxShadow: _addingSkill ? [] : [BoxShadow(
                            ...
                            child: Row(
                              ...
                              Icon(
                                _addingSkill
                                    ...
                                    : Icons.add_rounded,
                                color: _addingSkill
                                    ? _kTextSub : Colors.white, size: 20),
                              const SizedBox(width: 7),
                              Text(_addingSkill ? 'Zapri' : 'Dodaj veščino',
                                  style: TextStyle(
                                    color: _addingSkill
                                        ? _kTextSub : Colors.white,
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600)),
                            ]),
                          ),
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  icon: const Icon(
                                      ...
                                      size: 17),
                                  label: const Text('Potrdi in dodaj',
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 13)),
